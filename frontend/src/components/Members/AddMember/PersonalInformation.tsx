...
import { useMemberActions, useMemberDateOfBirth, useMemberFirstName, useMemberLastName, useMemberMiddleName, useMemberPlaceOfBirth, useMemberReligion } from "@/stores/memberStore";
...
export default function PersonalInformation() { 
  ...
  const { setFirstName, setLastName, setMiddleName, setDateOfBirth, setPlaceOfBirth, setReligion } = useMemberActions();
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div>
            ...
            <Input type="text" id="placeOfBirth" placeholder="Place of Birth" value={placeOfBirth} onChange={(e) => setPlaceOfBirth(e.target.value)} />
          </div>
          <div>
            <Label htmlFor="religion">Religion</Label>
            <Input type="text" id="religion" placeholder="Religion" value={religion} onChange={(e) => setReligion(e.target.value)} />
          </div>
        </div>
